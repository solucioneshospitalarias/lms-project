            ...
            <div className={styles.mainContainer}>
                ...
                <div className={styles.topSection}>
                    ...
                    <div className={styles.infoWrapper}>
                        <h2 className={styles.brandName}>RUTAS DEL <span>SABER</span></h2>
                        <p className={styles.description}>Comunícate con nosotros para conocer toda nuestra oferta educativa vial.</p>
                ...
                <div className={styles.formCard}>
                    ...
                    <div className={styles.imageSide}>
                        ...
                        <h2 className={styles.supportTitle}>¿Dudas con tu <span>proceso formativo?</span></h2>
                        <p className={styles.supportText}>
                            Si eres estudiante y necesitas apoyo con los materiales, talleres o acceso a la plataforma virtual, estamos aquí para guiarte en tu aprendizaje.
                        </p>
                        ...
                        <a href="https://wa.me/573234876604" className={styles.whatsappBtn}>
                            Contactar por WhatsApp
                        </a>

                        <div className={styles.supportImageContainer}>
                            <img src={imgFormulario} alt="Soporte Personalizado" className={styles.supportImage} />
                        </div>
                    </div>
                </div>
            </div>
