export const productosInformacion = [
    {
        id: "educacion-360",
        title: "Educación 360",
        ...
        no ocurre únicamente dentro del aula ni se limita al horario escolar. Parte de la idea de que niños, niñas y adolescentes aprenden en todos
        los espacios donde interactúan: en la familia, en la comunidad, en actividades culturales, deportivas, tecnológicas y sociales.
        Este modelo busca articular todos esos escenarios para ofrecer oportunidades educativas amplias, equitativas y de calidad.`,

        content2: `La Educación 360 promueve una formación que no solo se centra en contenidos académicos 
        tradicionales, sino también en el desarrollo de habilidades socioemocionales, pensamiento crítico, creatividad, trabajo en equipo y resolución de problemas.
        Reconoce que cada estudiante tiene talentos, ritmos e intereses distintos, por lo que propone una educación más personalizada y flexible. Además, fomenta la participación activa de la comunidad, las organizaciones sociales
        y las instituciones públicas y privadas como corresponsables del proceso educativo.`,

        content3: `Este enfoque también combate la desigualdad educativa al ampliar las oportunidades de aprendizaje más allá del aula, 
        especialmente para estudiantes en contextos vulnerables. Al integrar actividades artísticas, deportivas, científicas y comunitarias, la Educación 360 favorece un desarrollo más completo del individuo
...

    {
        ...
        objetivos: [
            "Prevenir conflictos y violencia.",
...

    {
        ...
        objetivos: [
            ...
            "Fomentar la participación activa en el cuidado ambiental.",
            "Contribuir al desarrollo sostenible."
        ],
        caracteristicas: [
            "Enfoque interdisciplinario.",
            "Formación en valores ecológicos.",
    ...
    },
    {
        ...
        estrategias: [
            "Reglamentos escolares participativos.",
    ...
    },
    {
        ...
        objetivos: [
            ...
            "Fomentar el respeto entre usuarios de la vía."
        ],
        caracteristicas: [
        ...
        estrategias: [
            "Simulaciones de tránsito.",
            "Charlas con autoridades.",
            "Campañas de sensibilización.",
            "Actividades didácticas sobre señales."
        ],
        color: "#8C7A30"
    }
];