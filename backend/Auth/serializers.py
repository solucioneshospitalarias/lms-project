...
from .models import (
    CustomUser, PerfilAlumno, PerfilProfesor, Colegios, 
    PadronAlumnos, PadronProfesores, SolicitudAcceso, ProfesorGrados
)
...
class PerfilAlumnoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PerfilAlumno
        fields = [
            'tipo_doc', 'nombre', 'apellido1', 'apellido2',
            'nombre_completo', 'fecha_nacimiento', 'fecha_expedicion',
            'departamento', 'municipio', 'telefono',
            'grado_actual', 'anio_vigencia', 'estado_alumno',
            'colegio'
        ]
...
class PerfilProfesorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'tipo_doc', 'nombres', 'apellido1', 'apellido2',
            'nombre_completo', 'fecha_nacimiento', 'fecha_expedicion',
            'telefono', 'estado_acc_profe', 'colegio', 'grados'
        ]
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = [
            'id', 'email', 'num_documento', 'user_type',
            'is_active', 'date_joined', 'perfil_alumno', 'perfil_profesor'
        ]
...
class SolicitudAccesoAlumnoSerializer(serializers.Serializer):
    ...
    # Datos del documento
    tipo_doc = serializers.ChoiceField(choices=[
...
class SolicitudAccesoListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'tipo_usuario', 'tipo_usuario_display',
            'num_documento', 'tipo_doc', 'email', 'nombre_completo',
            'estado', 'estado_display', 'validado_contra_padron',
