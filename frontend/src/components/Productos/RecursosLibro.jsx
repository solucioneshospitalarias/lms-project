...
const RecursosLibro = () => {
  ...
  const paginasContenido = [
    {
      image: "https://i.imgur.com/VT1sQQi.png",
    },
    {
      image: "https://i.imgur.com/ohHO7He.png",
    },
    {
      image: "https://i.imgur.com/JBcSCya.png",
    },
    {
      image: "https://i.imgur.com/8cWbUlE.png",
    },
    {
      image: "https://i.imgur.com/ILkil0j.png",
    },
    {
      image: "https://i.imgur.com/GFJz4zD.png",
    },
    {
      image: "https://i.imgur.com/sQaFDVh.jpeg",
    },
    {
      image: "https://i.imgur.com/K5XsHXs.png",
    },
    {
      image: "https://i.imgur.com/1BtynkP.png",
    },
    {
      image: "https://i.imgur.com/S9aRQwk.png",
    },
  ];
        ...
        <div className={`${styles.page} ${styles.cover}`}>
          ...
          <div className={styles.coverContent}>
            ...
            <div className={styles.ribbonContainer}>
              <div className={styles.ribbon}>¡APRENDE Y EXPLORA!</div>
            </div>
          </div>
        </div>

        {paginasContenido.map((pagina, i) => (
          <Page
            key={i}
            number={i + 1}
            image={pagina.image} // URL de la imagen del array
          ></Page>
        ))}
